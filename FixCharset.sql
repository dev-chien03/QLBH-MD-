-- Fix charset UTF-8 cho database và table
-- Drop tất cả foreign key constraints
SET FOREIGN_KEY_CHECKS=0;

-- Fix charset cho database
ALTER DATABASE DBquanlybanhang CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- Fix charset cho các bảng
ALTER TABLE LoaiSanPham CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
ALTER TABLE ChiTietHD CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE PhieuNhap CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE ChiTietPN CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- Bật lại foreign key checks
SET FOREIGN_KEY_CHECKS=1;

-- Xóa dữ liệu cũ theo thứ tự constraint
DELETE FROM HoaDon;
DELETE FROM SanPham;
